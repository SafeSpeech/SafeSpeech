...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-c", "--config", type=str, default="bert_vits2/configs/libritts_bert_vits2.json"
    )
    parser.add_argument(
    ...
    print(f"BERT generation completed! A total of {len(lines)} bert.pt files have been generated!")
